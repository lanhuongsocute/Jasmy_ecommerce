<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        ...
        <div>
            <h4 class="logo-text">Jasmy Shop</h4>
        </div>
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Order-Goods</div>
            </a>
            <ul>
                {{-- {{ route('all.goods') }} --}}
                <li> <a href="{{ route('all.goods') }}"><i class="bx bx-right-arrow-alt"></i>All Goods</a>
                </li>
                {{-- {{ route('add.goods') }} --}}
                <li> <a href="{{ route('update.goods') }}"><i class="bx bx-right-arrow-alt"></i>Edit Goods </a>
                </li>
            </ul>
        </li>
        <li>
